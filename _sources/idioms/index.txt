...
``drop-while`` によって条件に合致しないものを全て drop
...
同様の関数が
`medley <https://github.com/weavejester/medley/blob/master/src/medley/core.cljc#L6-L9>`__
というライブラリでも実装されています。 ただ、 Clojure
の場合遅延シーケンスがあるので条件に一致しない場合、処理が終了しない可能性があることに注意してください。
